    ...
    <div id="container-fluid">
        ...
        <div id="con">
            ...
            <form method="GET" action="" style="display: none; margin:2rem;" id="search_details" border="1">
                <div class="row">
                    <!-- <div class="col-2"></div> -->
                    <div class="col-3 fsize"><label><b>Student Name:</b></label><input type="text" class="form-control" name="name" placeholder="Name" maxlength=20 required></div>
                    <!-- <div class="col-2"></div> -->
            ...
            ?>
                ...
                ?>
                            ...
                            <hr class="my-hr-line" style="height:2px; color:gray;background-color:gray; margin:2.5rem; text-align:center">
                            <div style="text-align: center;  margin:2.5rem"">
                            <h4>Contact Us:</h4>
                            ...
                            <hr class="my-hr-line" style="height:2px; color:gray; background-color:gray;  margin:2.5rem">


        </div>

        <p align=center><code>Copyright (c) 2021, 2G4E</code></p>
    </div>
